...
const removeItem = (cartId, prodName) => {
  Swal.fire({
    title: "Are you sure you want to remove " + prodName + " from your cart?",
      ...
      <div class="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
        <div class="rounded-lg md:w-2/3">
          <div v-if="props.cartItems.length > 0">
            <div v-for="cart in cartItems" :key="cart.cart_id"
              class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
              <img :src="getPostImageUrl(cart.product_img)" alt="product-image" class="w-full rounded-lg sm:w-40" />
              <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div class="mt-4 flex-col justify-center sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                  ...
                  <div class="flex-col justify-end">
                    ...
                    <button type="button" @click="removeItem(cart.cart_id, cart.product_name)"
                      class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Remove
                      item</button>
                  </div>
                </div>
              </div>
          ...
          <div v-else>
            <div class="justify-between mb-6 rounded-lg bg-white p-6 shadow-md sm:flex sm:justify-start">
              <img src="https://www.seensil.com/assets/images/cart-empty.jpg" alt="product-image"
              ...
              <div class="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div class="mt-4 flex-col justify-center sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                  <div class="flex justify-start sm:justify-end border-gray-100 mb-2">
                    <input class="h-12 w-12 border bg-white text-center text-xs outline-none" type="number" min="1"
                      disabled />
                  </div>
                  <div class="flex-col justify-end">
                    <p class="text-sm"></p>
