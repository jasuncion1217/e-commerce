...
<template>
    <div>
        <div class="min-h-screen bg-gray-100">
            ...
            }" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform" aria-label="Sidebar">
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <button @click="showingSideBar = !showingSideBar"
                            :class="{
                                    'sm:hidden': showingSideBar,
                                    '': !showingSideBar,
                                }"
                    ...
                    <ul class="space-y-2 font-medium mt-20">
                        ...
                        <li>
                            <Link v-if="$page.props.auth.user.role === 'admin'" :href="route('users.index')"
                                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 22 21">
            ...
            :class="{
                '': showingSideBar,
                'sm:ml-64': !showingSideBar,
            }"
             class="dark:bg-gray-800 p-4 shadow" v-if="$slots.header">
                <div class="flex justify-between mx-auto py-2 sm:px-6 lg:px-8">
                    <div class="flex">
                        <button @click="showingSideBar = !showingSideBar"
                        :class="{
                            '': showingSideBar,
